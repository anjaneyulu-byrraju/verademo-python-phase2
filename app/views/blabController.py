    ...
    if request.method == "POST":
        ...
        try :
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute("INSERT INTO blabs (blabber, content, timestamp) values (%s, %s, %s)", (username, blab, timestamp))
    ...
    if request.method == "GET":
        ...
        try :
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute("%s", (blabDetailsSql % (blabid, ),))
    ...
    if request.method == "GET":
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                logger.info("Executing query to see Blab details")
                cursor.execute('%s = %s', (username, username))
