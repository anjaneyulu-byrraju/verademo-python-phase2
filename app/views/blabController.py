    ...
    if request.method == "POST":
        ...
        try :
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute("INSERT INTO blabs (blabber, content, timestamp) values (%s, %s)", (username, blab))
...
def morefeed(request):
    ...
    try :
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute("SELECT * FROM Blabs WHERE username =?", (username, ))
        ...
        try :
            ...
            with connection.cursor() as cursor:
                ...
                if (blabDetailsResults):
                    ...
                    cursor.execute("%s %s %s" % (blabCommentsSql, (blabid, )))
    ...
    if request.method == "GET":
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                logger.info("Executing query to see Blab details")
                cursor.execute(blabbersSql % (username, username), (username, username))
